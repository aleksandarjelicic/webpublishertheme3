			...
			<div class="contentPush col-md-12 col-sm-12 col-xs-12">
				<div class="row">
					...
					<div class="articleList col-lg-9 col-xs-12">
						...
						<div class="articleList__listSection articleList__listSection--gridView">
							...
							<article class="articleList__item">
								<a href="#">
									...
									<div class="articleList__info">
										<h3 class="articleList__headline">AUTOMATED CLIENT-SERVER EMULATION</h3>
										<p class="articleList__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque pellentesque odio mauris, nec malesuada lacus porta non. Maecenas et neque venenatis, tempus sem id, venenatis dui. Sed laoreet ex nunc, nec tincidun. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
										<div class="articleList__metadata">
											<img class="articleList__metadata__logo" src="../public/img/article_img/articleLogo.png">
											<span class="articleList__metadata__item">Fox</span>
											<span class="articleList__metadata__item">30 min ago</span>
